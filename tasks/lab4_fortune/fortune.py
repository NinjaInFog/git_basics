...
class Fortune:
    ...
    def print_values(self):
        print(self.diamond_value)
        print(self.hearts_value)
        print(self.clubs_value)
        print(self.spades_value)
...
for i in range(fortune.cards_amount):
    print(fortune.dealt_cards[i])

fortune.print_values()